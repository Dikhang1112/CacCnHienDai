...
from .models import (
    Post_Tenant, AdminManagement, Post_Landlord,
...
class AdminManagementAdmin(admin.ModelAdmin):
    list_display = ('amount_landlord', 'amount_tenant', 'admin_id', 'post_id')
    search_fields = ('admin_id', 'post_id')
...
class CommentAdmin(admin.ModelAdmin):
    list_display = ('content', 'user', 'created_at', 'updated_at', 'active')
